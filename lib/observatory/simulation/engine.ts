import type { PipelineStageId, ScenarioDefinition, SpanStatus, TraceSpan } from '@/lib/observatory/data/types';
import { STAGE_ORDER } from '@/lib/observatory/copy/labels';
