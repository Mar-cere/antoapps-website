...
export const CHOICE_LABELS: Record<string, string> = {
  ...
  shadow: 'Observó',
  applied: 'Aplicó',
  clarify_once: 'Aclarar una vez',
  honor_acceptance: 'Honrar la oferta',
  advance_with_value: 'Avanzar con un paso',
  hold_open: 'Seguir el hilo',
  close_explicit: 'Cerrar',
  unspecified: 'Sin estimar',
  high_activation: 'Alta activación',
  venting: 'Desahogo',
  missing_essential_fact: 'Falta un dato',
  question_streak: 'Racha de preguntas',
  short_affirmative_after_offer: 'Aceptó la oferta',
  topic_selected: 'Eligió un foco',
  concrete_help_requested: 'Pidió un paso',
  explicit_farewell: 'Despedida explícita',
  safety_precedence: 'Safety primero',
  insufficient_signal: 'Señal insuficiente',
  compatible: 'Compatible',
  violated: 'Viola la forma',
  unassessed: 'Sin evaluar',
  family_third_party: 'Tercero familiar',
  family_child_concern: 'Hilo de hija o hijo',
  third_party_concern: 'Tercero',
  listen_cue: 'Cue de escuchar',
  explicit_closure: 'Cierre explícito',
  conversion_suppression_planned: 'Supresión planificada',
  crisis_extras: 'Crisis',
  explicit_no_tools: 'Sin herramientas',
  vent_only: 'Solo desahogo',
  soft_ok_after_action: 'Ok suave tras acción',
  higher_priority_extra: 'Extra de mayor prioridad',
  exposure_ineligible: 'Exposición no elegible',
  mindfulness_ineligible: 'Mindfulness no elegible',
  anxiety_psycho_ineligible: 'Psicoed. no elegible',
  honor_unrelated: 'La oferta no coincide',
  budget_cap: 'Tope de extras',
  ambiguous_candidates: 'Candidatos ambiguos',
  policy_failure: 'Fallo de política',
  explicit_request: 'Pedido explícito',
  self_avoidance_workable: 'Trabajo propio viable',
  honor_offered_help: 'Honró la ayuda ofrecida',
  one: 'Una',
  multiple: 'Varias',
  bridge: 'Puente',
  explicit: 'Explícito',
  ...
  psychoeducation_anxiety: 'Psicoed. de ansiedad',
  embedded_technique: 'Técnica embebida',
  high: 'Alta',
  HIGH: 'Alta',
  mid: 'Media',
  MID: 'Media',
...
export const STRUCTURED_KEY_LABELS: Record<string, string> = {
  ...
  cue: 'Señal',
  reason: 'Motivo',
  structuralAlignment: 'Alineación',
  questionBand: 'Preguntas',
  closureBand: 'Cierre',
