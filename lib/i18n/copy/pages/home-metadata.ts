...
export function homePageMetadata(locale: Locale): Metadata {
  ...
  if (locale === 'en') {
    return {
      ...
      keywords:
        'Anto, ongoing emotional support, anxiety app, quiet hours, between therapy sessions, grounding, CBT, iPhone, Android, free trial, emotional support app',
      alternates,
      openGraph: {
        type: 'website',
        url: canonical,
        title: 'Anto — When everything costs a little more',
        description: `Ongoing emotional support for anxiety and quiet hours on iPhone and Android — between sessions or day to day. Complements care; does not replace a human therapist. ${trial.short}.`,
        siteName: 'Anto',
        locale: 'en_US',
        images: [ogImage],
      },
  ...
  return {
    ...
    keywords:
      'Anto, acompañamiento emocional, ansiedad, horas quietas, entre sesiones, grounding, TCC, app salud mental, iPhone, Android, prueba gratis',
    alternates,
    openGraph: {
      type: 'website',
      url: canonical,
      title: 'Anto — Cuando todo cuesta un poco más',
      description: `Acompañamiento emocional continuo para ansiedad y horas quietas en iPhone y Android — entre sesiones o en el día a día. Complementa — no reemplaza — a un terapeuta humano. ${trial.pricingNote}`,
      images: [ogImage],
      siteName: 'Anto',
      locale: 'es_CL',
    },
    twitter: {
      card: 'summary_large_image',
      title: 'Anto — Cuando todo cuesta un poco más',
      description: `Acompañamiento emocional continuo para ansiedad y horas quietas en iPhone y Android — entre sesiones o en el día a día. Complementa — no reemplaza — a un terapeuta humano. ${trial.short}.`,
      images: [ogImageUrl],
    },
  };
}
