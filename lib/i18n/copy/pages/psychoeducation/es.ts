...
const guides: Record<PsychoeducationSlug, PsychoeducationGuide> = {
  ...
  [SLUGS.scales]: {
    ...
    productMoment: {
      ...
      chat: {
        ...
        messages: [
          {
            role: 'user',
            text: 'Me salió más alto que la vez pasada. ¿Eso ya es un diagnóstico?',
          },
          {
            role: 'anto',
          ...
          {
            role: 'user',
            text: 'Van dos veces seguidas. Me asusta el número.',
          },
          {
            role: 'anto',
    ...
    furtherReading: {
      title: 'Ir más a fondo',
      support:
        'Si el ánimo es lo que está detrás del número, sigue aquí — señales, duración y un paso pequeño:',
      links: [
        {
          label: 'Depresión: guía breve',
          description:
            'Cuando el bajón dura, qué suele ayudar y cómo se distingue de una tristeza puntual.',
          href: '/recursos/depresion-guia-breve',
        },
      ],
    },
    references: {
      title: 'Referencias (APA)',
      support:
        'Validaciones originales de las escalas. Los rangos de esta página salen de esos estudios; no sustituyen evaluación clínica individual.',
      items: [
        {
          ...
          note: 'Validación del PHQ-9 y rangos de severidad (0–27) usados como orientación de cribado.',
        },
        {
          apa: 'Spitzer, R. L., Kroenke, K., Williams, J. B. W., & Löwe, B. (2006). A brief measure for assessing generalized anxiety disorder: The GAD-7. Archives of Internal Medicine, 166(10), 1092–1097. https://doi.org/10.1001/archinte.166.10.1092',
          href: 'https://doi.org/10.1001/archinte.166.10.1092',
          note: 'Validación del GAD-7; punto de corte ≥10 para probable TAG y rangos de severidad (0–21).',
        },
      ],
    },
    ...
    howTo: {
      ...
      description:
        'Pasos para interpretar un resultado de cribado: periodo, rango publicado, tendencia y cuándo llevarlo a un profesional. No diagnostica.',
      totalTime: 'PT5M',
      steps: [
        'Confirma el periodo: las escalas preguntan por las últimas dos semanas, no por el día de hoy.',
        'Sitúa el número en el rango publicado (orientación, no etiqueta).',
        'Si hay lecturas anteriores, compara: importa más la tendencia que un punto aislado.',
        'Si se mantiene alta, llévala a un profesional; no cierres un diagnóstico con el número solo.',
        'Si hay riesgo o no puedes cuidarte, prioriza ayuda de emergencia.',
      ],
    },
  },
  ...
  [SLUGS.sleepMap]: {
    ...
    layout: 'dossier',
    meta: {
      title: 'Sueño e insomnio: mapa clínico completo | Anto',
      description:
        'Mapa clínico de sueño e insomnio: presentaciones, ciclo de mantenimiento, límites de la higiene del sueño, componentes tipo TCC-I (control de estímulos, ventana de sueño), vínculo con ansiedad/ánimo y cuándo pedir evaluación. Complementa la guía breve; no diagnostica ni sustituye terapia del sueño.',
      openGraphTitle: 'Sueño e insomnio — mapa clínico',
      openGraphDescription:
        'Más allá de una mala noche: qué sostiene el insomnio, hasta dónde llega la higiene y qué suele incluir la TCC-I.',
      keywords:
        'insomnio, sueño, mapa clínico, mapa sueño, TCC-I, terapia cognitivo-conductual para el insomnio, higiene del sueño, control de estímulos, restricción de sueño, ventana de sueño, eficiencia del sueño, ciclo de mantenimiento, rumiación nocturna, ansiedad nocturna, insomnio crónico, psicoeducación, Anto',
    },
    hero: {
    ...
    sections: [
      ...
      },
      {
        ...
        ordered: true,
        bullets: [
          'Acuéstate solo cuando tengas sueño — no “porque ya toca” con el cuerpo muy activado.',
          'Cama para dormir (y sexo): no trabajo, no scroll, no discusiones largas.',
          'Si no concilias unos 20 minutos, sal a otra estancia con luz tenue; haz algo quieto sin pantallas brillantes.',
          ...
          'Anota tres noches: tiempo en cama frente a sueño aproximado. Solo observación, no juicio.',
        ],
      },
      {
    ...
    productMoment: {
      title: 'Así se ve en Anto',
      body: 'Puedes describir el patrón tal cual y recibir un paso concreto — salir de la cama, ritual en papel o bajar activación — sin pretender resolver el sueño entero en una noche.',
      ...
      chat: {
        ...
        messages: [
          ...
          {
            role: 'anto',
            text: 'Eso suena a ciclo de mantenimiento: más tiempo en cama y comprobaciones. ¿Esta noche podemos probar salir a luz tenue si no hay sueño en unos 20 minutos?',
          },
          {
            role: 'user',
          ...
          {
            role: 'anto',
            text: 'Aparquemos el teléfono. Si no hay sueño, sal un rato quieto — y mantén la hora de levantarte. Después comparamos qué pasó con lo que temías.',
          },
        ],
      },
      suggestionsLabel: 'Ejemplos en la app',
    ...
    furtherReading: {
      title: 'Ir más a fondo',
      support: 'Para un ritual corto esta noche, ansiedad en paralelo o material público de referencia:',
      links: [
        {
          label: 'Cuando no puedes dormir (guía breve)',
          description:
            'Hábitos de descanso, ritual si la mente no para y cuándo pedir ayuda.',
          href: '/recursos/higiene-sueno-salud-mental',
        },
        {
          label: 'Ansiedad y preocupación',
    ...
    references: {
      ...
      items: [
        ...
        },
        {
          apa: 'Irish, L. A., Kline, C. E., Gunn, H. E., Buysse, D. J., & Hall, M. H. (2015). The role of sleep hygiene in promoting public health: A review of empirical evidence. Sleep Medicine Reviews, 22, 23–36. https://doi.org/10.1016/j.smrv.2014.10.001',
          href: 'https://doi.org/10.1016/j.smrv.2014.10.001',
          note: 'Límites y utilidad de la higiene del sueño en población general frente al tratamiento clínico.',
        },
        {
    ...
    howTo: {
      ...
      steps: [
        ...
        'Si no hay sueño en unos 20 minutos, sal a luz tenue y vuelve sin forzar.',
        'Mantén la misma hora de levantarte al día siguiente.',
        'Observa tres noches: tiempo en cama frente a sueño aproximado.',
      ],
    },
  },
  [SLUGS.mindfulness]: {
