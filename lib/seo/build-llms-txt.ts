...
const PAGE_SUMMARIES: Record<Locale, Record<string, string>> = {
  es: {
    ...
    '/comparar': 'Comparativa honesta: Anto vs chatbots genéricos y apps de bienestar (acompañamiento, privacidad, límites clínicos).',
  ...
  en: {
    ...
    '/comparar': 'Honest comparison: Anto vs generic chatbots and wellness apps (support, privacy, clinical limits).',
