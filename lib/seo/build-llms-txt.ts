...
const PAGE_LABELS: Record<Locale, Record<string, string>> = {
  es: {
    ...
    '/investigacion': 'Base científica: evidencia de categoría (TCC, escalas, apps) con APA y límites honestos',
  ...
  en: {
    ...
    '/investigacion': 'Scientific basis: category evidence (CBT, scales, apps) with APA citations and honest limits',
...
const PAGE_SUMMARIES: Record<Locale, Record<string, string>> = {
  es: {
    ...
    '/investigacion': 'Cómo Anto se informa de TCC, GAD-7, agentes conversacionales e intervenciones digitales; citas APA; no ensayos propios de Anto.',
    '/recursos':
  ...
  en: {
    ...
    '/investigacion': 'How Anto is informed by CBT, GAD-7, conversational agents, and digital interventions; APA citations; no Anto-specific trials claimed.',
    '/recursos':
