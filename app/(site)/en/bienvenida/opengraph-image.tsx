...
export const alt = 'Anto — Emotional support for anxiety on iPhone and Android';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

export default function BienvenidaOpenGraphImageEn() {
  const copy = getBienvenidaCopy('en');
  const trial = getTrialCopy('en');
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>iPhone and Android app</span>
          <span>·</span>
