...
## Memorable moment
Campo vivo a la derecha; al bajar, la cámara se acerca a un nudo (lado, arriba, cerca) y deja el resto de la figura al borde. Cada pensamiento es una columna de lectura precisa: título más tres párrafos. Al CTA, el campo se queda quieto y bajo; la confianza es solo tipo.
