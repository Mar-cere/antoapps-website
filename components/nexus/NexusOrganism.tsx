...
void main() {
  ...
  float quiet = 0.4 + tissue * 0.12 + wake * 0.015;
  float mid = 0.5 + focus * 0.04 + wake * 0.02 + pulse * 0.015;
  float lit = 0.58 + focus * 0.04 + wake * 0.02;
  float hot = 0.8 + nexus * 0.03 + sync * 0.02;
